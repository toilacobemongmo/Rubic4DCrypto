# 1. BẢNG S-BOX VÀ KHỞI TẠO BẢNG HOÁN VỊ SO(4)
SBOX = [
...
def main():
    print("=" * 80)
    print("KIỂM THỬ KHÁNG TẤN CÔNG TÍCH PHÂN (INTEGRAL / SQUARE DISTINGUISHER)")
    print("=" * 80)
    ...
    for r in range(1, 9):
        ...
        for val in range(256):
            pt = [0] * 16
            pt[0] = val  # 1 byte Active (0..255), 15 byte Constant (0)
